...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-08-2024 a las 11:17:24
...
INSERT INTO `responsable` (`idResp`, `nombUsuario`, `contrasenia`, `nombres`, `appPaterno`, `appMaterno`, `telefono`, `correoElec`, `numControl`, `grupo`, `idRoles`) VALUES
(1, 'MrMexico2014', 0x4c696e75783230323421, 'Zahir Andrés', 'Rodríguez', 'Mora', '4281061609', 'rodriguez.mora.zahir.15@gmail.com', '1223100456', 'GDS0632', 4),
(3, 'Otro', 0x4c696e75783230323421, 'Ejemplo', 'E', 'J', '4281234567', 'mrmexico2014@gmail.com', '1223456', 'GDS0632', 2),
(5, 'Administrador', 0x4c696e75783230323421, 'Samantha', 'Rodriguez', 'Mora', '4281088148', 'samantha@gmail.com', '12234122', 'GDS0632', 1);
...
--
ALTER TABLE `responsable`
  MODIFY `idResp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `rol`
--
ALTER TABLE `rol`
  MODIFY `idRoles` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
